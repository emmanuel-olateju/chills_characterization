...
FRISSON_MARKER_STREAMS = configs["FRISSON_MARKER_STREAMS"]
...
CHILLS_REPORT_WINDOW = configs["CHILLS_REPORT_WINDOW"]
PLOT_TIME_WINDOW = configs["PLOT_TIME_WINDOW"]
...
FRISSON_CHILLS_DATA_DIR = configs["FRISSON_CHILLS_DATA_DIR"]
